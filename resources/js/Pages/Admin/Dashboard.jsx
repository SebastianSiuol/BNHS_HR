                    ...
                    <div className="container px-5 mx-auto">
                        ...
                        <div className="flex flex-wrap -m-4">
                            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                                <div
                                    className="border-4 border-blue-800 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                            ...
                            <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
                                <div
                                    className="border-4 border-blue-800 px-4 py-6 rounded-lg transform transition duration-500 hover:scale-110">
                                        ...
                                        <form className="p-4 md:p-5">
                                            <div className="grid gap-4 mb-4 grid-cols-2">
                                                <div className="col-span-2">
                                                    <label htmlFor="name"
                                                           className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Announcement
                                                        Title</label>
                                                ...
                                                <div className="col-span-2">
                                                    <label htmlFor="joining-letter"
                                                           className="block mr-8 mb-2 text-sm font-medium text-gray-900 ">Attach
                                                        File</label>
                                                    <input
                                                        ...
                                                        id="file_1" type="file"/>
                                                    <input
                                                        className="hidden w-full mb-2 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50  focus:outline-none   "
                                                        id="file_2" type="file"/>
                                                    <input
                                                        className="hidden w-full mb-2 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50  focus:outline-none   "
                                                        id="file_3" type="file"/>
