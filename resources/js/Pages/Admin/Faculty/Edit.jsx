...
function AddressForm() {
    ...
    function copyAddress(e) {
        ...
        const residentialFields = watch(["residential_house_num", "residential_street", "residential_subdivision", "residential_barangay", "residential_city", "residential_province", "residential_zip_code"]);
        ...
        <>
            <form>
                <div className="relative grid grid-cols-none lg:grid-cols-2 gap-16">
                    <button onClick={copyAddress} className={"absolute right-2 -top-20 my-2 py-1 px-4 bg-blue-600 text-sm font-bold text-white border border-blue-600 rounded-3xl hover:bg-blue-800 hover:text-grey-600 hover:border-blue-800"}>
                        Copy Residential to Permanent
                    </button>

                    <div>
                        <div className="flex items-center">
                            <h6 className="font-semibold">Residential Address</h6>
                        </div>

                        {/* First Row! */}
                        <div className="mt-2 grid gap-4 grid-cols-2">
                            <LabeledInput id={"residential_house_num"} register={register} label={"House/Block/Lot No."} placeholder={"House/Block/Lot No."} color={"black"} width={"normal"} error={errors} />

                            <LabeledInput id={"residential_street"} register={register} label={"Street"} placeholder={"Street"} color={"black"} width={"normal"} error={errors} />
                        </div>

                        {/* Second Row! */}
                        <div>
                            <LabeledInput id={"residential_subdivision"} register={register} label={"Subdivision/Village"} placeholder={"Subdivision/Village"} color={"black"} width={"normal"} error={errors} />
                        </div>

                        {/* Third Row! */}
                        <div className="mt-2 grid gap-4 grid-cols-2">
                            <LabeledInput id={"residential_barangay"} register={register} label={"Barangay"} placeholder={"Barangay"} color={"black"} width={"normal"} error={errors} />
                            <LabeledInput id={"residential_city"} register={register} label={"City/Municipality"} placeholder={"City/Municipality"} color={"black"} width={"normal"} error={errors} />
                        </div>

                        {/* Fourth Row! */}
                        <div className="mt-2 grid gap-4 grid-cols-2">
                            <LabeledInput id={"residential_province"} register={register} label={"Province"} placeholder={"Province"} color={"black"} width={"normal"} error={errors} />
                            <LabeledInput id={"residential_zip_code"} register={register} label={"Zip Code"} placeholder={"Zip Code"} color={"black"} width={"normal"} error={errors} />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        {/* First Row! */}
                        <div className="mt-2 grid gap-4 grid-cols-2">
                            <LabeledInput id={"permanent_house_num"} register={register} label={"House/Block/Lot No."} placeholder={"House/Block/Lot No."} color={"black"} width={"normal"} error={errors} />

                            <LabeledInput id={"permanent_street"} register={register} label={"Street"} placeholder={"Street"} color={"black"} width={"normal"} error={errors} />
                        </div>

                        {/* Second Row! */}
                        <div>
                            <LabeledInput id={"permanent_subdivision"} register={register} label={"Subdivision/Village"} placeholder={"Subdivision/Village"} color={"black"} width={"normal"} error={errors} />
                        </div>

                        {/* Third Row! */}
                        <div className="mt-2 grid gap-4 grid-cols-2">
                            <LabeledInput id={"permanent_barangay"} register={register} label={"Barangay"} placeholder={"Barangay"} color={"black"} width={"normal"} error={errors} />
                            <LabeledInput id={"permanent_city"} register={register} label={"City/Municipality"} placeholder={"City/Municipality"} color={"black"} width={"normal"} error={errors} />
                        </div>

                        {/* Fourth Row! */}
                        <div className="mt-2 grid gap-4 grid-cols-2">
                            <LabeledInput id={"permanent_province"} register={register} label={"Province"} placeholder={"Province"} color={"black"} width={"normal"} error={errors} />
                            <LabeledInput id={"permanent_zip_code"} register={register} label={"Zip Code"} placeholder={"Zip Code"} color={"black"} width={"normal"} error={errors} />
                        </div>
                    </div>
                </div>
