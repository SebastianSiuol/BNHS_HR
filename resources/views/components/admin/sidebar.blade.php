        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <x-admin.sidebar-button href="{{ route('admin.rpms.index') }}" :active="request()->is('admin/rpms*')" type="top">
                    <svg class="flex-shrink-0 w-5 h-5 transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
