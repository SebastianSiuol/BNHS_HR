<aside id="sidebar-multi-level-sidebar" class=" bg fixed top-0 left-0 z-40 w-80 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    ...
    <div class="h-full px-3 py-4 overflow-y-auto">
        <ul class="space-y-2 font-medium">
            ...
            <li class="mb-6">
                <x-admin-sidebar-button href="/admin/home" :active="request()->is('admin/home')" type="top">
            ...
            <li>
                ...
                <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="sub-employee-buttons" data-collapse-toggle="sub-employee-buttons">
                ...
                <ul id="sub-employee-buttons" class=" {{request()->is('admin/employees*') ? '' : 'hidden' }} ml-10 py-2 space-y-2">
                    <li>
                        <x-admin-sidebar-button href="/admin/employees/create" :active="request()->is('admin/employees/create')" type="sub">Add Employee</x-admin-sidebar-button>
                    </li>
                    <li>
                        <x-admin-sidebar-button href="/admin/employees" :active="request()->is('admin/employees')" type="sub">Manage Employees</x-admin-sidebar-button>
                    </li>
                </ul>
            </li>
            <li>
