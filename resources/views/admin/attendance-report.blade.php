        ...
        <form id="myForm" action="#">
            <div id="dailyAttendance-filter" class="bg-white mb-5 border w-full border-blue-900 rounded-md shadow sm:p-8 p-6">
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-5">
                    ...
                    <div class="mt-7">
                        <button id="showReport" type="button" class="w-full text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Show Report
                        </button>
                    </div>
                </div>
            ...
            <!-- ATTENDANCE TABLE -->
            <div id="report_attendanceTable" class="hidden bg-white border w-full border-gray-200 rounded-md shadow p-4">
                <!-- HEADER -->
