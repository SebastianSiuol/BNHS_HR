                            ...
                            <x-table.data>
                                <div class="flex items-center justify-end">
                                    ...
                                    <button data-modal-target="view-modal-{{$faculty->id}}"
                                        ...
                                        <svg class="w-[27px] h-[27px] text-green-600 " aria-hidden="true"
                                    ...
                                    <a href="/admin/employees/{{$faculty->id}}/edit">
                                        <svg class="w-[27px] h-[27px] text-blue-800 " aria-hidden="true"
                                    ...
                                    <button data-modal-target="delete-employee-{{$faculty->id}}-modal"
                                        ...
                                        <svg class="w-[27px] h-[27px] text-red-800 " aria-hidden="true"
                                             xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                             fill="currentColor" viewBox="0 0 24 24">
                                            <path fill-rule="evenodd"
