    ...
    <div class="px-3 py-2 lg:px-5 lg:pl-3">
        ...
        <div class="flex items-center justify-end">
            <div class="flex items-center ms-3">
                <div>
                    <button type="button"
                            class="text-sm bg-gray-200 rounded-full pr-2 pl-1 py-1 inline-flex items-center space-x-4"
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div>
                            <label for="contact-person"
                                ...
                                Person</label>
                            <input type="contact-person" name="contact-person" id="contact-person"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                   placeholder="Contact Person Full Name" required="">
                        </div>
                        <div>
                            <label for="birthdate" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date
                                of Birth</label>
                            <div class="relative w-full">
                                ...
                                <input id="birthdate-picker" datepicker datepicker-buttons datepicker-autoselect-today
                                       type="text"
                        ...
                        <div>
                            ...
                            <div class="mt-4">
                                <label for="R1-Name"
                                       class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Reference 1
                                    Name</label>
                                <input type="text" name="R1-Name" id="R1-Name"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                       placeholder="Full Name" required="">
                            </div>
                            <div class="mt-4">
                                ...
                                <input type="R1-Phone" name="R1-Phone" id="R1-Phone"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                       placeholder="09xxxxxxxxx" required="">
                            </div>
                            <div class="mt-4">
                                <label for="R2-Name"
                                       class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Reference 2
                                    Name</label>
                                <input type="text" name="R2-Name" id="R2-Name"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                       placeholder="Full Name" required="">
                            </div>
                            <div class="mt-4">
                                <label for="R2-Phone"
                                       class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Reference 2
                                    Contact Number</label>
                                <input type="R2-Phone" name="R2-Phone" id="R2-Phone"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                       placeholder="09xxxxxxxxx" required="">
                            </div>
                        </div>
                        <div>
                            <label for="local_address"
                                   class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Local
                                Address</label>
                            <textarea type="text" id="local-address"
                ...
                <div class="bg-white border w-full border-blue-900 rounded-md shadow sm:p-8 p-6">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" disabled name="emp_id" id="emp_id"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                   placeholder="Dropbox URL" required="">
                        </div>
                        <div>
                            ...
                            <input type="text" disabled name="emp_id" id="emp_id"
                                   class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                   placeholder="Google Drive URL" required="">
                        </div>
                    </div>
