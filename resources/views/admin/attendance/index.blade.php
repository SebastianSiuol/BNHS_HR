...
<x-slot:heading>Daily Attendance</x-slot:heading>
    ...
    <x-admin.main_container>
            ...
            <form id="myForm"
                  action="#">
                <div class="bg-white mb-5 border w-full border-blue-900 rounded-md shadow sm:p-8 p-6">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-4">
                        <div>
                            ...
                            <select id="department" name="department" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
                        ...
                        <div>
                            ...
                            <select id="shift" name="shift" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required="">
                                <option selected value=0>All Shifts</option>
                        ...
                        <div>
                            <label for="attendance_date" class="block mb-2 text-sm font-medium text-gray-900 ">Date</label>
                        ...
                        <div class="mt-7">
                            <button id="getEmployee" type="submit" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                                Get Employee
                            </button>
                        </div>
                    </div>
