    ...
    <div class="flex h-screen">
        ...
        <div class="fixed top-0 bottom-0 lg:right-0 w-[300px] bg-white">
            <div class="w-full h-full bg-gray-50 p-8 flex flex-col items-center justify-center">
                ...
                <a href="/admin/log_in" class="w-full bg-blue-500 text-white py-2 px-4 rounded text-center mb-4 hover:bg-blue-600">Admin</a>
                <a href="/staff/log_in" class="w-full bg-red-500 text-white py-2 px-4 rounded text-center mb-4 hover:bg-red-600">Staff</a>
