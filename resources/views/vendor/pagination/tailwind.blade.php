@if ($paginator->hasPages())
    ...
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between pt-4">

            {{-- Default Showing--}}
            <div>
                <p class="text-sm font-normal text-gray-500  mb-4 md:mb-0 block w-full md:inline md:w-auto">
                    {!! __('Showing') !!}
